...
CUSTOM_TEXT = (
    str(PMPERMIT_TEXT)
    if PMPERMIT_TEXT
    else f"__Halo kontol, saya bot yang menjaga room chat Karman-Userbot {DEFAULTUSER} di mohon jangan melakukan spam , kalau anda melakukan itu OTOMATIS saya akan memblockir anda!__ \n"
)
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════╗\n"
    "    🚫 𝗣𝗘𝗥𝗜𝗡𝗚𝗔𝗧𝗔𝗡 🚫 \n"
