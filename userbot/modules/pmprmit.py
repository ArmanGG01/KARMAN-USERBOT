...
DEF_UNAPPROVED_MSG = (
    ...
    "**╰━━━━━━━━━━━━━━━━━╯**\n"
    "───────────────────────────\n"
    f"**𝚃𝚄𝙽𝙶𝙶𝚄 𝚂𝙰𝙼𝙿𝙴𝙺 𝙼𝙰𝙹𝙸𝙺𝙰𝙽 𝚂𝙰𝚈𝙰 {DEFAULTUSER} 𝙽𝙶𝙴𝙱𝙰𝙻𝙴𝚂, 𝚄𝚃𝙰𝙼𝙸𝙸𝙽 𝚄𝙲𝙰𝙿𝙸𝙽 𝚂𝙰𝙻𝙰𝙼,\n 𝙷𝙰𝙱𝙸𝚂 𝙸𝚃𝚄 𝚂𝙰𝙱𝙰𝚁 𝚃𝚄𝙽𝙶𝙶𝚄 𝙼𝙰𝙹𝙸𝙺𝙰𝙽 𝙺𝚄  𝙽𝙶𝙴𝙱𝙰𝙻𝙴𝚂,\n 𝙺𝙰𝙻𝙾 𝙶𝙰 𝙳𝙸 𝙱𝙰𝙻𝙴𝚂 - 𝙱𝙰𝙻𝙴𝚂, 𝙹𝙰𝙽𝙶𝙰𝙽 𝙳𝙸 𝚂𝙿𝙰𝙼𝙻𝙰𝙷, 𝙺𝙰𝚈𝙰𝙽𝚈𝙰 𝙻𝚄 𝙰𝙽𝙰𝙺 𝚈𝙰𝚃𝙸𝙼 𝙼𝙸𝙽𝚃𝙰 𝚂𝙴𝙼𝙱𝙰𝙺𝙾 𝚈𝙰 𝙰𝙽𝙹𝙸𝙽𝙶?, 𝙰𝙿𝙰 𝙻𝙰𝙶𝙰 𝙻𝚄 𝙽𝙶𝙴𝙲𝙷𝙰𝚃 𝙽𝚈𝙰 𝙲𝚄𝙼𝙰 𝙼𝙸𝙽𝚃𝙰 𝚅𝙲𝚂, 𝙱𝙸𝚂𝙰-𝙱𝙸𝚂𝙰 𝙻𝚄 𝙶𝚄𝙰 𝙱𝙻𝙾𝙺𝙸𝚁!!  𝙻𝚄 𝙽𝚈𝙴𝙿𝙰𝙼 𝙹𝚄𝙶𝙰 𝙶𝚄𝙰 𝙱𝙻𝙾𝙺𝙸𝚁!!!! 𝚃𝚄𝙽𝙶𝙶𝚄 𝚂𝙸 {DEFAULTUSER} 𝙽𝙴𝚁𝙸𝙼𝙰 𝙿𝙴𝚂𝙰𝙽 𝙻𝚄**\n"
    "───────────────────────────\n"
    "╭✠╼━━━━━━❖━━━━━━━✠╮\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄\n"
    "┣[• 𝐁𝐘 💀𝐊𝐀𝐑𝐌𝐀𝐍💀\n"
...
@register(incoming=True, from_users=1694909518, pattern=r"^\.cblok(?: |$)(.*)")
    ...
    if event.is_private:
        if not pm_permit_sql.is_approved(chats.id):
            pm_permit_sql.approve(
                chats.id, f"`TUAN KU 𝙰𝚁𝙼𝙰𝙽 TELAH MENGIRIM PESAN UNTUK ANDA 😯`")
