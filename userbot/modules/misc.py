...
from userbot import ALIVE_NAME, BOTLOG, BOTLOG_CHATID, CMD_HELP, IG_ALIVE, OWNER_BOT, REPO_NAME, bot
...
async def killdabot(event):
    ...
    await event.edit("`Menonaktifkan KARMAN-USERBOT....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`KARMAN-USERBOT Telah Dinonaktifkan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting KARMAN-USERBOT...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`KARMAN-USERBOT Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[KARMAN-USERBOT Repo](https://github.com/ArmanGG01/KARMAN-USERBOT/blob/KARMAN-USERBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**✠╼━━━━━━❖━━━━━━━✠**\n  [{REPO_NAME}](https://github.com/ArmanGG01/KARMAN-USERBOT)\n✠╼━━━━━━❖━━━━━━━✠\n┌PEMILIK         : [𝐎𝐖𝐍𝐄𝐑]({OWNER_BOT})\n├CHANNEL      : [𝐈𝐍𝐅𝐎](t.me/DeployBot01)\n├GROUP           : [𝐆𝐑𝐎𝐔𝐏](https://t.me/obrolansuar)\n└INSTAGRAM  :  [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE})"
    )
